<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-2xl font-bold tracking-tight text-gray-900">Nueva Unidad de Medida</h2>
                <p class="text-sm text-gray-500 mt-0.5">Define nombre y equivalencia</p>
            </div>
        </div>
    </x-slot>
        ...
        <div class="overflow-hidden bg-white border border-gray-200 shadow-sm rounded-xl">
            <div class="px-5 py-4 border-b border-gray-100 bg-gray-50">
                <h3 class="flex items-center gap-2 text-sm font-semibold text-gray-700">
                    <svg class="w-4 h-4 text-indigo-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"/></svg>
                    Datos de la unidad
                </h3>
            </div>
            <div class="p-5">
                <form method="POST" action="{{ route('unidades.store') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input id="nombre" name="nombre" type="text" required autofocus
                            value="{{ old('nombre') }}"
                            placeholder="Ej. Pieza, Docena, Caja..."
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-400 mt-1.5">Ej. 1 para pieza, 12 para docena, 24 para caja</p>
