<x-app-layout>
    ...
    <div class="py-8 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        {{-- ── ALERTAS ── --}}
        @if(session('success'))
            <div class="flex items-center gap-3 px-4 py-3 mb-4 text-sm text-green-800 border border-green-200 rounded-lg bg-green-50">
        ...
        @endif
        @if(session('error'))
            <div class="flex items-center gap-3 px-4 py-3 mb-4 text-sm text-red-800 border border-red-200 rounded-lg bg-red-50">
